...
class Imagenes:
    ...
    def inicializar_gui(self):
        ...
        #ubicar la cara top
        img_face_top=Image.open('Cara_top.jpg')
        ...
        img_face_bottom=Image.open('Cara_bottom.jpg')
        ...
        #ubicar la cara back
        img_face_back=Image.open('Cara_back.jpg')
        ...
        img_face_front=Image.open('Cara_front.jpg')
        ...
        #ubicar la cara left
        img_face_left=Image.open('Cara_left.jpg')
        ...
        img_face_right=Image.open('Cara_right.jpg')
